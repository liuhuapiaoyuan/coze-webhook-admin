...
interface DataTableProps<TData, TValue> {
  ...
  loading?: boolean;
  virtual?: boolean;
  rowVirtualOptions?: Partial<Parameters<typeof useVirtualizer>[0]>;
  columnVirtualOptions?: Partial<Parameters<typeof useVirtualizer>[0]>;
}
...
export function DataTable<TData, TValue>({
  ...
  const columnVirtualizer = useVirtualizer(
    Object.assign(defaultColumnOptions, columnVirtualOptions)
  );

  const rowVirtualizer = useVirtualizer(
    Object.assign(defaultRowOptions, rowVirtualOptions)
  );
